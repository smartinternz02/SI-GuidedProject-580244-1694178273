...
fun screen10(navController: NavController) {
    ...
    Column{
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                ...
                Column(modifier = Modifier,) {
                    Text(text = "veg noodles", modifier = Modifier,
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.mushnoodles),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "Mushroom Noodles", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.chicknoodles),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "Chicken noodles", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))
