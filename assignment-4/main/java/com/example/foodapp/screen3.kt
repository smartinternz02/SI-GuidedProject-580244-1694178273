...
fun screen3(navController: NavController) {
    ...
    Column{
        ...
        Card(modifier = Modifier
            .fillMaxWidth()
            .size(135.dp), onClick = { navController.navigate("screen4") }) {

            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.nonvegpizza),
                    contentDescription = "veg pizza"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "veg Pizza", modifier = Modifier,
        ...
        Card(modifier = Modifier
            .fillMaxWidth()
            .size(135.dp), onClick = {navController.navigate("screen5")}) {

            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.vegpizza),
                    contentDescription = "Non veg Pizza"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "Non veg Pizza", modifier = Modifier,
                        style = TextStyle(fontSize = 30.sp), fontWeight = FontWeight.ExtraBold
                    )
