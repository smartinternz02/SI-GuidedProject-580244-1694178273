...
fun screen13(navController: NavController) {
    ...
    Column{
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.muttonbiri),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "Mutton Biryani", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.prawn),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "Prawn biryani", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))
