    ...
    Column{
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.buffchipizza),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "Buffalo Chicken Pizza", modifier = Modifier,
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.bbqvegpizza),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "BBQ Chicken Pizza", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))

                    Text(text = "$ 13.99", modifier = Modifier,
                        style = TextStyle(fontSize = 16.sp), fontWeight = FontWeight.Bold)
                    Spacer(modifier = Modifier.width(10.dp))
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.alfpizza),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "Chicken Alfredo Pizza", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))

                    Text(text = "$ 14.99", modifier = Modifier,
                        style = TextStyle(fontSize = 16.sp), fontWeight = FontWeight.Bold)
                    Spacer(modifier = Modifier.width(10.dp))
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.pestopizza),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "chicken pesto pizza ", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))
                    ...
                    Row {
                        ...
                        Spacer(modifier = Modifier.width(5.dp))
                        Text(text = "3.9 (70+)",style = TextStyle(fontSize = 16.sp))
                        Spacer(modifier = Modifier.width(20.dp))
                        Text(text = "ADD TO CART")
                        Image(painter = painterResource(id = R.drawable.cart), contentDescription = "cart", modifier = Modifier.size(21.dp))
                    }
