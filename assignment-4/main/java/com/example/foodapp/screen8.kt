    ...
    Column{
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.friedchicken4),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "4 Piece Fried chicken", modifier = Modifier,
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                Image(painter = painterResource(id = R.drawable.friedchicken),
                    contentDescription = "dominos"
                )
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "8 piece fried chicken", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))
        ...
        Card(modifier = Modifier
            ...
            Row (modifier = Modifier, verticalAlignment = Alignment.CenterVertically){
                ...
                Spacer(modifier = Modifier.width(30.dp))
                Column(modifier = Modifier,) {
                    Text(text = "Fries", modifier = Modifier,
                        style = TextStyle(fontSize = 20.sp), fontWeight = FontWeight.ExtraBold
                    )
                    Spacer(modifier = Modifier.width(16.dp))
